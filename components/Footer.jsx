  ...
  const navGroups = [
    {
      title: "Explore",
      links: [
        { label: "Himachal", href: "/packages?region=himachal" },
        ...
        >
          ...
          <div style={{ maxWidth: 280 }}>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.7, color: "#64748b", marginBottom: 20 }}>
              Curating authentic group travel experiences across the Himalayas and beyond since 2020.
            </p>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <div style={{ fontSize: 13, color: "#64748b", display: "flex", gap: 12, alignItems: "center" }}>
                ...
                <a href="mailto:humsafarcommunity4@gmail.com" style={{ color: "inherit", textDecoration: "none" }}>humsafarcommunity4@gmail.com</a>
              </div>
              <div style={{ fontSize: 13, color: "#64748b", display: "flex", gap: 12, alignItems: "center" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.6 }}>
                ...
                <a href="tel:+916268496389" style={{ color: "inherit", textDecoration: "none" }}>+91 62684 96389</a>
              </div>
              <div style={{ fontSize: 13, color: "#64748b", display: "flex", gap: 12, alignItems: "flex-start" }}>
                ...
                <span>Maharaj Wada, Gwalior, India</span>
              </div>
            </div>
          </div>
        </div>
